    ...
    static class ZDOMan_ConnectPortals
    {
        static ZDOID FindNewId(List<ZDOID> allPortals, ZDOID oldId)
        {
            ...
            foreach (var newId in allPortals)
            {
                ...
                var previousId = newZdo.GetZDOID(BugattiBoys.Key_PreviousId);
        ...
        static bool Prefix()
        {
            ...
            foreach (ZDOID portalId in allPortalIds)
            {
                ...
                var targetId = portalZdo.GetZDOID(BugattiBoys.Key_TargetId);
                ...
                if (targetZdo == null || string.IsNullOrEmpty(targetZdo.GetString(BugattiBoys.Key_PreviousId)))
                {
                ...
                portalZdo.Set(BugattiBoys.Key_TargetId, targetId);
            }
            ...
            {
                ZDO portalZdo = ZDOMan.instance.GetZDO(portalId);
                portalZdo?.Set(BugattiBoys.Key_PreviousId, portalId);
            }
